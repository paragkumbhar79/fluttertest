...
#Solution 
- Take one int variable for checking the tap and checked when it is 3 then increment the count.
- for checking tap and making text clickeble RichText is used and for click event SpanText is used.